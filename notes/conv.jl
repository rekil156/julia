...
# ╔═╡ e50b3e90-1bc4-11eb-3cfd-e1eeb6f7de9d
import Pkg;

# ╔═╡ ec87c664-1bc6-11eb-345c-ef7d0febbd2d
begin
    Pkg.add(["ImageIO", "ImageMagick", "ImageFiltering","QuartzImageIO", "FFTW", "PlutoUI","DSP","Statistics","Plots"])
    using ImageIO
end

# ╔═╡ d0059012-1bc5-11eb-0c54-f34c96240637
...
# ╔═╡ 8fed963e-1bc8-11eb-1bbc-df1a5bc537b0
fourier_spectrum_magnitudes(conv_image)
