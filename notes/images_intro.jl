...
# ╔═╡ 6186a12a-1b2b-11eb-0583-cf81950f8eba
md"""
multiple expressions in begin-end block
"""

# ╔═╡ 91b22406-1b2a-11eb-2912-77e5bc6b44d7
z = begin
    x = 1
    y = 2
    x + y
...
# ╔═╡ 262854c0-1b2b-11eb-1048-d1a61afcbd56
a = begin b =1; c=4; b+c end

# ╔═╡ 3c8bc08a-1b2b-11eb-3069-4fb1269adda0
z1 = (x1 = 1; y1 = 2; x1 + y1)
...
begin 
	...
	new_phil2[200:300, 100:300] .= RGB(0, 1, 1)
	new_phil2
end
...
# ╔═╡ b450a3c6-1b29-11eb-28f8-dd8af3e8eeb3
@doc decimate
...
# ╔═╡ 75962d1e-1b37-11eb-09c3-fb67b895bc0e
decimate(head,repeat_count)
